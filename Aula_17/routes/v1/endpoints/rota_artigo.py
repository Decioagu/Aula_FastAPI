...
# get_session: responsável por abrir e fechar sessão no Banco de Dados
# get_current_user:  verificar o token JWT, extrai as informações do usuário correspondente
