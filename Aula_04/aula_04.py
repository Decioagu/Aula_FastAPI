...
# instanciar API
app = FastAPI(title='Aula 04', version='0.0.4', description= 'Alua 17 até 19')
...
cursos = {
    ...
    4: {
        "titulo": "Programação linguagem C++",
        "aulas": 38,
        "horas":52
    }
}
...
@app.get('/msg')
# APP Insomnia: clique na aba "Headers" abaixo do campo da URL <===============================================
# header: x-msg | value: Decio Santana de Aguiar <===============================================
...
# Subir o servidor: uvicorn Aula_04.aula_04:app --reload